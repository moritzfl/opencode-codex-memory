...
1. Read `{{ diff_path }}` to see what's new or changed.
...
5. Do not access the network. Do not run bash. Only read and write files in the workspace.
6. When done, respond with a one-line summary of what you changed.